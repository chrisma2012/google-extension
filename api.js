        ...
        (e => {
          ...
          return new Promise((e, r) => {
            ...
            s[t.method](t.url, n, { adapter: f, rpcBuffer: n, headers: i })
              .then(i => {
                if (200 !== i.status) r({ message: '发生错误', description: i.data.message, requestOpt: t, rpcOpt: n.opt, req: JSON.stringify(t.data) });
                else {
                  const o = u(t.rpcOutDesction, new Uint8Array(i.data));
                  o && 0 === o.ret ? ((i.data = o.rsp ? u(t.resDesction, o.rsp) : {}), e(i.data)) : r({ message: 9999 === o.ret ? `[${t.funcName}]网络开小差了，请稍后再试~` : `[${t.funcName}]${o.desc}`, description: o.desc, allDescription: o, requestOpt: t, rpcOpt: n.opt, req: JSON.stringify(t.data) });
                }
              })
              .catch(e => {
                r({ description: e.message, message: `[${t.funcName}]网络开小差了，请稍后再试~~`, requestOpt: t, rpcOpt: n.opt, req: JSON.stringify(t.data) });
              });
          });
